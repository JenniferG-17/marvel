    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <button class="btn btn-primary" v-on:click="validarFormulario(), crear_vengador(nombres, apellidos, heroe, trabajo, telefono, email)">Agregar vengador</button>
      </div>
  </div>
</div>
    ...
    methods: { //Inician los Métodos
        ...
        crear_vengador: function (nombres, apellidos, heroe, trabajo, telefono, email) {
            if (!(Array.isArray(this.errores) && this.errores.length)) {
                let self = this;
                axios.post('https://marvel-e0038.firebaseio.com/vengadores.json', {
                    nombres: nombres,
                    apellidos: apellidos,
                    heroe: heroe,
                    trabajo: trabajo,
